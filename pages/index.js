  ...
  return (
    <main>
      ...
      <section className={Theme.u_layout}>
        <header className={Styles.header} data-test="header">
          <div className={Styles.header_txt}>
            ...
            <p className={cx(Styles.header_count, Theme.t_tiny, Theme.t_bold)}>
              {emplKeys.length}{' '}
              {emplKeys.length === 1 ? 'employee' : 'employees'}
            </p>
          </div>
        ...
        <TablePretty className={Styles.table} data-test="table">
          ...
          <TablePretty.Body>
            {emplKeys.map(uid => (
              <TablePretty.Row key={uid}>
                <TablePretty.RowCell>
                  <div>
                    <div className={cx(Theme.t_lg, Styles.table_name)}>
                      {employees[uid].name}
                    </div>
                ...
                <TablePretty.RowCell>
                  <Button
                    href={`employee?uid=${uid}`}
                    variant="light"
                    aria-label={`Edit ${employees[uid].name} profile`}
                  >
                    Edit
                  </Button>
                </TablePretty.RowCell>
